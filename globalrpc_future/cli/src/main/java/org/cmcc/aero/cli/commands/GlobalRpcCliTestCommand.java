 ...
 */
package org.cmcc.aero.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.cmcc.aero.cli.api.GlobalRpcCliCommands;
...
public class GlobalRpcCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(GlobalRpcCliTestCommand.class);
    protected final GlobalRpcCliCommands service;

    public GlobalRpcCliTestCommand(final GlobalRpcCliCommands service) {
