...
public class RedisCacheService implements AutoCloseable{
    ...
    private RedisCacheService(String ipStr, Integer port, String password, int database){
        redisClient = new RedisClient(ipStr, port, password, database);
        jedis = redisClient.getClient();
    }

    public static RedisCacheService createInstance(String ipStr, Integer port, String password, int database){
        return new RedisCacheService(ipStr, port, password, database);
    }

    public static RedisCacheService createInstance(String ipStr, int port, String password){
