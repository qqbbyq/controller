...
public class DataCreator {
    ...
    public FruitKey createFruit(String name){
        ...
        FruitBuilder fruit = new FruitBuilder().setKey(fruitKey).setName(name).setAge("0").setColor("red");
    ...
    public void createAndModifyFruit() throws InterruptedException {
        String name = "grape" + new Random().nextInt();
        FruitKey fruitKey = createFruit(name);
        Thread.sleep(2000);
        FruitBuilder fruit = new FruitBuilder()
          .setKey(fruitKey)
//          .setName(name).setAge("0")
          .setColor("purple");
