...
public class AkkatestCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(AkkatestCliTestCommand.class);
    protected final AkkatestCliCommands service;

    public AkkatestCliTestCommand(final AkkatestCliCommands service) {
